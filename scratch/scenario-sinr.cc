...
#include "ns3/config.h" // Include the Config API header
#include "ns3/propagation-loss-model.h" // Include the FixedRssLossModel header
...
//
//void UpdatePathLossModel(std::string modelType)
//{
//    NS_LOG_UNCOND("Applying 50 dB fixed loss globally...");
//    // Update the path loss model type globally
//    Config::Set("/ChannelModel/$ns3::ThreeGppChannelModel/PathlossModelType", StringValue(modelType));
//}
// Function to update the Path Loss model globally
 //void UpdatePathLossModel(std::string modelType)
 //{
 //    NS_LOG_UNCOND("Updating Path Loss Model to " << modelType);
 //
 //    // Set the new path loss model type globally
 //    Config::Set("/ChannelModel/$ns3::ThreeGppChannelModel/PathlossModelType", StringValue(modelType));
 //
 //    // Apply additional fixed attenuation for high-loss scenarios
 //    if (modelType == "ns3::FixedRssLossModel")
 //    {
 //        Config::Set("/ChannelModel/$ns3::ThreeGppChannelModel/FixedLoss", DoubleValue(100.0)); // Add 100 dB of fixed attenuation
 //    }
 //}
 //
 //// Function to update the Channel model globally
 //void UpdateChannelModel(std::string modelType)
 //{
 //    NS_LOG_UNCOND("Updating Channel Model to " << modelType);
 //
 //    // Set the new channel model type globally
 //    Config::Set("/ChannelModel/$ns3::ThreeGppChannelModel/ChannelConditionModelType", StringValue(modelType));
 //
 //    // Apply additional parameters for high-loss scenarios
 //    if (modelType == "ns3::ThreeGppRmaChannelConditionModel")
 //    {
 //        Config::Set("/ChannelModel/$ns3::ThreeGppChannelModel/ShadowingEnabled", BooleanValue(true));
 //        Config::Set("/ChannelModel/$ns3::ThreeGppChannelModel/ShadowingStd", DoubleValue(20.0)); // Very high shadowing standard deviation
 //    }
 //}
 //
 ////
// Function to update the Path Loss model dynamically
// Function to update the Path Loss model dynamically

// Function to update the Path Loss model dynamically for mmWave spectrum channels
// Function to update the Path Loss model using MmWaveHelper
// Function to update the Path Loss model dynamically for mmWave spectrum channels

// Function to update the Channel model dynamically for mmWave spectrum channels
 //void UpdatePathLossModel(std::string modelType)
 //{
 //    // Update the path loss model type globally
 //    Config::Set("/ChannelModel/$ns3::ThreeGppChannelModel/PathlossModelType", StringValue(modelType));
 //
 //    // Optionally, add additional fixed attenuation to simulate blockage
 //    if (modelType == "ns3::ThreeGppV2vUrbanPropagationLossModel")
 //    {
 //        Config::Set("/ChannelModel/$ns3::ThreeGppChannelModel/FixedLoss", DoubleValue(50.0)); // Add 50 dB of fixed attenuation
 //    }
 //}
 //void UpdatePathLossModel(std::string modelType)
 //{
 ...
 //    Config::Set("/ChannelModel/$ns3::ThreeGppChannelModel/PathlossModelType", StringValue(modelType));
 //
 //    // Apply additional fixed attenuation for the bad channel
 //    if (modelType == "ns3::FixedRssLossModel")
 //    {
 //        Config::Set("/ChannelModel/$ns3::ThreeGppChannelModel/FixedLoss", DoubleValue(50.0)); // Add 50 dB of fixed attenuation
 //    }
 ...
 ////
 //
 //void UpdatePathLossModel()
 //{
 //    NS_LOG_UNCOND("Applying 50 dB fixed loss globally...");
 //
 //    // Create and install a FixedRssLossModel with 50 dB loss
 //    Ptr<FixedRssLossModel> fixedLossModel = CreateObject<FixedRssLossModel>();
 //    fixedLossModel->SetAttribute("Rss", DoubleValue(-50.0)); // Apply 50 dB loss
 //
 //    // Add the fixed loss model to the global propagation loss model
 //    Config::Set("/ChannelList/*/$ns3::SpectrumChannel/PropagationLossModel", PointerValue(fixedLossModel));
 //
 //    NS_LOG_UNCOND("Applied 50 dB fixed loss globally.");
 //}
 ////
...
static ns3::GlobalValue g_simTime ("simTime", "Simulation time in seconds", ns3::DoubleValue (4),
...
main (int argc, char *argv[])
{
  ...
  //
//  Config::SetDefault("ns3::LogDistancePropagationLossModel::Exponent", DoubleValue(4.0)); // High exponent
//  Config::SetDefault("ns3::LogDistancePropagationLossModel::ReferenceLoss", DoubleValue(100.0)); // High reference loss
 ...
 // SetNoLossPathLossModel(); // No loss for Path Loss model
 // SetNoLossChannelModel();  // No loss for Channel model
  ...
  speed->SetAttribute ("Max", DoubleValue (0.001));
  ...
  //
  //
//  Simulator::Schedule(Seconds(0.5), &UpdatePathLossModel, "ns3::FixedRssLossModel"); // Most lossy PL model
//  Simulator::Schedule(Seconds(0.5), &UpdateChannelModel, "ns3::ThreeGppRmaChannelConditionModel"); // Most lossy Channel model
  // Install mmWave, lte, mc Devices to the nodes
 // Simulator::Schedule(Seconds(0.5), &UpdatePathLossModel, mmwaveHelper); // Apply most lossy Path Loss model
 // Simulator::Schedule(Seconds(0.5), &UpdateChannelModel, mmwaveHelper);  // Apply most lossy Channel model
									 //
									 //
  ...
  // Schedule the most lossy models after 0.5 seconds
 // Simulator::Schedule(Seconds(0.5), &UpdatePathLossModel, "ns3::FixedRssLossModel"); // Most lossy PL model
 // Simulator::Schedule(Seconds(0.5), &UpdateChannelModel, "ns3::ThreeGppRmaChannelConditionModel"); // Most lossy Channel model
//  Simulator::Schedule(Seconds(0.5), &UpdatePathLossModel, "ns3::ThreeGppV2vUrbanPropagationLossModel");
//  Simulator::Schedule(Seconds(2.0), &UpdatePathLossModel, "ns3::FixedRssLossModel");
 // Simulator::Schedule(Seconds(0.5), &UpdatePathLossModel);
//  Simulator::Schedule(Seconds(0.5), &UpdatePathLossModel); // Apply most lossy Path Loss model
//  Simulator::Schedule(Seconds(0.5), &UpdateChannelModel);  // Apply most lossy Channel model
 //
