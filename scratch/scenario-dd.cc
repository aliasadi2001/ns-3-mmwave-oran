...
// Function to update LogDistancePropagationLossModel parameters
...
main (int argc, char *argv[])
{
  ...
  Config::SetDefault ("ns3::LogDistancePropagationLossModel::Exponent", DoubleValue (5.8)); // Set the path loss exponent
  Config::SetDefault ("ns3::LogDistancePropagationLossModel::ReferenceDistance", DoubleValue (1)); // Reference distance in meters
  Config::SetDefault ("ns3::LogDistancePropagationLossModel::ReferenceLoss", DoubleValue (50)); // Path loss at reference distance in dB
  ...
  //
  //
  // Retrieve the propagation loss model from the mmWave channel
  //
  // Start applications
